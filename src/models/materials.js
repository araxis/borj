...
export function MATS() {
  ...
  cache = {
    ...
    zabulStone: std({ map: noiseTexture(0xa88657, 0.055), roughness: 0.98 }),
    zabulStoneLight: std({ map: noiseTexture(0xbd9a65, 0.045), roughness: 0.96 }),
    zabulStoneDark: std({ map: noiseTexture(0x73583a, 0.05), roughness: 1.0 }),
    zabulEarth: std({ map: noiseTexture(0x8c6c43, 0.055), roughness: 1.0 }),
