      ...
      if (state === 'bossCloseup') {
        ...
        return {
          ...
          boss: boss ? {
            ...
            animType: boss.model?.animType || null,
            glb: boss.model?.animType === 'gltf',
            visualSource: boss.model?.visualSource || null,
            assetKey: boss.model?.assetKey || null,
            actionNames: boss.model?.actionNames || (boss.model?.anim?.actions ? Object.keys(boss.model.anim.actions) : []),
            fallbackReason: boss.model?.fallbackReason || null,
            sourceAsset: boss.model?.sourceAsset || null,
            actorProfile: boss.model?.actorProfile || boss.model?.group?.userData?.actorProfile || null,
